...
\title{jClustering v1.2.4 user manual}
...
This manual refers to jClustering v1.2.4 and beyond. It will not be edited just to update this version number. Unless
...
\item {\em Skip noisy voxels:} This is an experimental function that skips voxels with a time-activity curve that can be 
considered noise. As the {\em ImagePlusHypIterator} object now does not return voxels that have been masked, this functionality is deprecated and unchecked by default but has not yet been removed
\end{itemize}
